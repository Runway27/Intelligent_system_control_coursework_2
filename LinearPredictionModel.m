%% THIS CODE IS FOR THE LINEAR PREDICTION MODEL ONLY TEMPERATURE VARIABLES OF X33
clc;
clear;
...
SelVar=[2, 8, 13, 15];  %Specify the index numbers of the variables you wish to include in the model (between 1 and 35)
