%% THIS CODE IS FOR THE LINEAR PREDICTION MODEL FOR ONLY CALENDER RELATED VARIABLES FROM X33 AND IT IS THE BEST MODEL WITH LEAST RMSE VALUE
clc;
clear;
...
SelVar=[30, 32, 34, 35];  %Specify the index numbers of the variables you wish to include in the model (between 1 and 35)
